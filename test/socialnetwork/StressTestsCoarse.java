...
import socialnetwork.StressTestsFine.ExperimentSettings;
import socialnetwork.domain.Backlog;
import socialnetwork.domain.Board;
import socialnetwork.domain.Message;
import socialnetwork.domain.Worker;

public class StressTestsCoarse {
  @Test
  public void testSmallParamsFine() {
    StressTestsFine.ExperimentSettings settings = new StressTestsFine.ExperimentSettings(1, 5, 50, 3, 123456);
    runExperiment(settings);
  }

  @Test
  public void testMediumParamsFine() {
    StressTestsFine.ExperimentSettings settings = new StressTestsFine.ExperimentSettings(3, 10, 50, 10, 123456);
    runExperiment(settings);
  }

  @Test
  public void testSlightlyLargerParamsFine() {
    StressTestsFine.ExperimentSettings settings = new StressTestsFine.ExperimentSettings(5, 40, 75, 15, 123456);
    runExperiment(settings);
  }

  @Test
  public void testLargeParamsFine() {
    StressTestsFine.ExperimentSettings settings = new StressTestsFine.ExperimentSettings(10, 100, 100, 20, 123456);
    runExperiment(settings);
  }
  ...
  private void runExperiment(StressTestsFine.ExperimentSettings settings) {
